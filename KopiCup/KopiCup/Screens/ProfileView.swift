...
struct ProfileView: View {
    ...
    @AppStorage("profile.name") private var storedName: String = "Guest"
    ...
    var body: some View {
        ...
        .confirmationDialog("Вы действительно хотите выйти?", isPresented: $showLogoutConfirm, titleVisibility: .visible) {
...
// MARK: - System image picker (UIKit)
